...
@Entity
@Table(name="goods_trend")
public class GoodsTrend {
	@Id
	@Column(name="id")
	private int id;
	...
	public GoodsTrend(int id, int good_id, int comment_num, float good_rate, int good_comment_num, int mid_comment_num,
			int bad_comment_num, float price, int create_time) {
		super();
		this.id = id;
		this.good_id = good_id;
		this.comment_num = comment_num;
	...
	public String toString() {
		return "GoodsTrend [id=" + id + ", good_id=" + good_id + ", comment_num=" + comment_num + ", good_rate="
